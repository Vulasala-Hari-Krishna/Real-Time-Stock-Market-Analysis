...
def sample_prices() -> list[float]:
    ...
    return [
        150.0, 152.0, 149.0, 153.0, 155.0,
        154.0, 156.0, 158.0, 157.0, 160.0,
        162.0, 161.0, 163.0, 165.0, 164.0,
        166.0, 168.0, 167.0, 170.0, 172.0,
        171.0, 173.0, 175.0, 174.0, 176.0,
        178.0, 177.0, 180.0, 182.0, 181.0,
    ]
...
def sample_volumes() -> list[int]:
    ...
    return [
        1000000, 1100000, 950000, 1050000, 1200000,
        1000000, 1150000, 980000, 1080000, 1100000,
        1020000, 1060000, 1000000, 1130000, 1050000,
        1070000, 1000000, 1090000, 1040000, 1110000,
        1000000, 1050000, 1080000, 1020000, 5000000,
    ]
